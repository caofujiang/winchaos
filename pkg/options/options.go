...
func (o *Options) AddFlags() {
	...
	o.Flags.StringVar(&o.License, "license", "0813d72a71ba41ed986e507e2e0ead1b", "license")
	o.Flags.StringVar(&o.AgentMode, "agent.mode", AgentHostMode, "mode of the agent")
	if tools.IsWindows() {
		o.Flags.StringVar(&o.InstallOperator, "install.operator", InstallOperatorWindows, "operator of the agent")
